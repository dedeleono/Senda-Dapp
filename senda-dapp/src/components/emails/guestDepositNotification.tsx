...
export default function GuestDepositNotificationEmail({
  inviteUrl,
  receiverEmail,
  amount,
  token,
  ...
  return (
    <Html>
      <Head />
      <Preview>{`${senderName || receiverEmail} has sent you ${amount} ${token} through Senda`}</Preview>
      <Tailwind>
        <Body className="bg-white font-sans">
          <Container className="mx-auto py-8 px-4">
            ...
            <Text className="text-gray-600 mb-4">
              You can use this email address ({receiverEmail}) to create a new account.
            </Text>
